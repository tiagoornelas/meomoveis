 ...
 <main>
		...
		<div class="popupFixo">
				<div class="miniPopupContent">
				 <h1 class="tituloBanner">Realizar Assistência</h1><br><br>
				 <h3 class="aviso">
					 <?php
						 print "Você realizou a assistencia de $produto?";
						?>
				 </h3><br>

				 <form class="form" method="post" action=<?php echo "includes/realizar_assistencias-inc.php?id='$id'" ?>>

					 <input id="botaoDeletar" class="botao" name="submit" type="submit" value="Realizei">
				 </form>
					 <button id="botaoCancelarDeletar" class="botaoSair"><a href="logistica_assistencias.php" class="hideLink">Cancelar</a></button>
			 </div>
		 </div>
