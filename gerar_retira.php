      ...
      $endereco = $exibirResultados[5];}
		 ...
		 <div class="popupFixo">
		     <div class="miniPopupContent">
			    <h1 class="tituloBanner">Gerar Retira</h1><br><br>
					<h3 class="aviso">
						<?php
						...
						while($exibirResultados = mysqli_fetch_array($search)) {
							...
							print "Você quer gerar necessidade de retira para o produto $produto?"; }
						 ?>
					</h3><br>

			 		<form class="form" method="post" action=<?php echo "includes/gerar_retira-inc.php?id=$id" ?>>
