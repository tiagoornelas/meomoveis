 ...
 <main>
		...
		<div class="popupFixo">
				<div class="miniPopupContent">
				 <h1 class="tituloBanner">Realizar Retira</h1><br><br>
				 <h3 class="aviso">
					 <?php
						 print "Você realizou o retira de $produto?";
						?>
				 </h3><br>

				 <form class="form" method="post" action=<?php echo "includes/realizar_retiras-inc.php?id='$id'" ?>>

					 <input id="botaoDeletar" class="botao" name="submit" type="submit" value="Realizei">
				 </form>
					 <button id="botaoCancelarDeletar" class="botaoSair"><a href="logistica_retiras.php" class="hideLink">Cancelar</a></button>
			 </div>
		 </div>
